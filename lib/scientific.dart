              ...
              Container(
                ...
                child: Table(
                  children: [
                    ...
                    TableRow(
                      children: [
                        buildbutton("sqrt", 1, Colors.teal),
                        buildbutton("mod", 1, Colors.teal),
                        buildbutton("log", 1, Colors.teal),
                        buildbutton("^", 1, Colors.black),
                      ],
                    ),
                    TableRow(
                      children: [
                        buildbutton("sin", 1, Colors.teal),
                        buildbutton("cos", 1, Colors.teal),
                        buildbutton("tan", 1, Colors.teal),
